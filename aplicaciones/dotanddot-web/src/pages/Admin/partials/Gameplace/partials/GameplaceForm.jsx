...
function GameplaceForm({ formData, cities, onChange, onSubmit, onCancel }) {
  return (
      ...
      <form onSubmit={onSubmit}>
        <div className='admin-form-section'>
          <div className='admin-form-grid'>
            ...
            <label>
              <span>City*</span>
              <select name="idCity" value={formData.idCity} onChange={onChange} required>
