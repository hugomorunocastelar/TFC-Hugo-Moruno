...
@Data
public class GameDetailsWOUTDto implements DtoMapper<GameDetails, GameDetailsWOUTDto> {
    ...
    @Override
    public GameDetailsWOUTDto to(GameDetails entity) {
        if (entity == null) return null;
        GameDetailsWOUTDto dto = new GameDetailsWOUTDto();
    ...
    @Override
    public GameDetails from(GameDetailsWOUTDto dto) {
