...
import dot.server.serverApp.model.Match.entity.*;
...
public class GameDto implements DtoMapper<Game, GameDto> {
    ...
    private GameInitialSituationDto initialSituation;
    ...
    public GameDto to(Game entity) {
        ...
        dto.setInitialSituation(new GameInitialSituationDto().to(entity.getInitialSituation()));
        ...
        dto.setResult(new GameResultDto().to(entity.getResult()));
    ...
    public Game from(GameDto dto) {
        ...
        entity.setInitialSituation(new GameInitialSituationDto().from(dto.getInitialSituation()));
        ...
        entity.setResult(new GameResultDto().from(dto.getResult()));
